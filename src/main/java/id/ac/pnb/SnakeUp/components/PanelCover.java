...
import id.ac.pnb.SnakeUp.swing.ButtonOutLine;
...
public class PanelCover extends javax.swing.JPanel {
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        GradientPaint gra = new GradientPaint(0, 0, new Color(0, 0, 0), 0, getHeight(), new Color(0, 0, 0));
        g2.setPaint(gra);
    ...
    public void login(boolean login) {
        if (this.isLogin != login) {
            if (login) {
                ...
                description.setText("Enter to start playing");
